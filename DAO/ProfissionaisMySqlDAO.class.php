...
class ProfissionaisMySqlDAO implements ProfissionaisDAO{
	...
	public function load($idProfissionais, $timesIdTimes){
		$sql = 'SELECT * FROM Profissionais WHERE idProfissionais = ?  AND Times_idTimes = ? ';
	...
	public function delete($idProfissionais, $timesIdTimes){
		$sql = 'DELETE FROM Profissionais WHERE idProfissionais = ?  AND Times_idTimes = ? ';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($idProfissionais);
		$sqlQuery->setNumber($timesIdTimes);
	...
	public function insert($profissionai){
		$sql = 'INSERT INTO Profissionais (nome, dataNascimento, rg, posicao, time, salario, habilidade, idProfissionais, Times_idTimes) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)';
		$sqlQuery = new SqlQuery($sql);
		...
		$sqlQuery->set($profissionai->time);
		...
		$sqlQuery->setNumber($profissionai->timesIdTimes);
	...
	public function update($profissionai){
		$sql = 'UPDATE Profissionais SET nome = ?, dataNascimento = ?, rg = ?, posicao = ?, time = ?, salario = ?, habilidade = ? WHERE idProfissionais = ?  AND Times_idTimes = ? ';
		$sqlQuery = new SqlQuery($sql);
	...
	protected function readRow($row){
		...
		$profissionai->timesIdTimes = $row['Times_idTimes'];
